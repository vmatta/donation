...
public class Donor implements Validate {
    ...
    public Donor(String orderId, String title, String firstName, String lastName, String suffix, String streetAddress1, String streetAddress2, String streetAddress3, String city, String state, String zip, String country, String phone, String fax, String email, String preferredContactMethod, boolean anonymous) {
